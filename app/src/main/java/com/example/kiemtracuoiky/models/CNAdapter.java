...
public class CNAdapter extends RecyclerView.Adapter<CNAdapter.UserViewHolder> {
    ArrayList<CN> lstUser;
    Context context;
    CNAdapter.UserCallback userCallback;

    public CNAdapter(ArrayList<CN> lstUser) {
    ...
    public UserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        CNAdapter.UserViewHolder viewHolder = new CNAdapter.UserViewHolder(userView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull UserViewHolder holder,@SuppressLint("RecyclerView") int position) {
        CN item = lstUser.get(position);
    ...
    public interface UserCallback {
        void onClick(CN cn, int position);
        void onItemDeleteClicked(CN cn, int position);
        void onItemEditClicked(CN cn, int position);
    }
}
